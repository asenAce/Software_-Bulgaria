...
namespace HomeWork.Six.cs
{
    class NumberCalc
    {
        static void Main(string[] args)
        {
            dynamic[] doubleArr =
            {
                1.1,2.2,0.3,1.4,6.5,6.6,1.7,8.8,0.9
            };

            dynamic[] intArr =
            {
                1,2,31,4,15,6,17,18,9
            };
            ...
            Console.WriteLine("Sum member --> double {0} integer {1}", GetSum(doubleArr), GetSum(intArr));
            Console.WriteLine("Products member --> double {0} integer {1}", GetProduct(doubleArr), GetProduct(intArr));
            Console.WriteLine("Average member --> double {0} integer {1}", GetAverage(doubleArr), GetAverage(intArr));
        }
