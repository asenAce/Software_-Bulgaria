...
namespace _06.Snake
{
    public class Snakes
    {
        ...
        private static int countOfSnakesFound;
        ...
        public static void Main(string[] args)
        {
            ...
            // used to prevent snake from overlapping itself
            Stack<Cell> snake = new Stack<Cell>();
            List<char> directions = new List<char>();

            GenerateSnake(new Cell { Row = 0, Column = 0 }, 'S', snake, directions);

            Console.WriteLine("Snakes count = {0}", countOfSnakesFound);
        }
        ...
        private static void GenerateSnake(Cell cell, char direction, Stack<Cell> snake, List<char> directions)
        {
            ...
            // First cell is fixed as 'R'; removes three branches of unneeded recursion
            if (snake.Count > 1)
            {
