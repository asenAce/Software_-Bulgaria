...
<body>
    ...
    <?php
		...
		$query_economy = "SELECT * FROM country_madagascar";
		$send_economy_query = mysqli_query($connection_countries,$query_economy);
		
		while($row=mysqli_fetch_assoc($send_economy_query)){
			
			$madagascarResource= $row['country_land_and_resources'];
		}
	
	?>
    <div class=" navbar-header pull-right" style="padding:20px;">
           <img src="countries_images/madagascar_flag.jpg" width="500" height="400" alt="madagascar_flag"/>    
    </div>
    <div class=" navbar-header pull-left" style="padding:20px;">
           <img  src="countries_images/political-map-of-Madagascar.gif" width="400" height="600" alt="political_map_madagascar"/>
    </div>
    <div class="container" style="background:url(countries_images/tan-textured-background-3-300x200.jpg);">
    	<h2 style="color:black;"><b><?php echo" $madagascarResource"; ?></b></h2>
    </div>
</body>
</html>