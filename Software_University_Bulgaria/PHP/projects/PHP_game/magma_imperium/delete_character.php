...
<body>
    ...
    <div class="container">
      ...
      <?php
	  		if(isset($_GET['delcharacterId'])){
				
				$del_characterID=$_GET['delcharacterId'];
				
				$query_del = "DELETE FROM palyers WHERE player_id = '$del_characterID' ";
				$delete_send = mysqli_query($query_del);
