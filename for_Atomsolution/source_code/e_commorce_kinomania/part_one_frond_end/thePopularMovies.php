    ...
    <div class="wrapper">
    	<div class="container-fluid">
          ...
          <?php
				   			if(isset($_GET['p_id'])){
								$thePopular_movie_id = $_GET['p_id'];
								
								$sellectThePopularMovie = $theConnection->executeTheQuery("SELECT * FROM popular_movies WHERE id='$thePopular_movie_id'");
		  ...
		  ?>                  
                        	<div class="well clearfix">
                            	...
                            	<div class="col-lg-3 text-center col-md-2" >
                                   ...
                                   <a href="#">
                                	<img   class="img-responsive" src="img/movies_popular/<?php echo $movie_post_img; ?>">
                                   </a> 
