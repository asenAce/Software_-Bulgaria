   ...
   <?php
						 ...
						 if($page == "" || $page==1){
			   			 ...
			   			 $newMoviesQueryCount="SELECT * FROM popular_movies";
   ...
   ?>                     
                        	<div class="well clearfix">
                            	<div class="col-lg-3 text-center col-md-2">
                                  <a href="thePopularMovies.php?p_id=<?php echo $movie_id; ?>">	
                                	<img class="img-thumbnail" src="img/movies_popular/<?php echo $movie_movie_post_img; ?>">
                                ...
                                <div class="col-lg-12">
                                	<a  href="thePopularMovies.php?p_id=<?php echo $movie_id; ?>"class="btn btn-lg btn-warning pull-right">See More Info</a>
 ...
 <ul class="pager">
    	<?php
			for($i=1;$i<= $count;$i++){
				echo "<li><a href='popular_movies.php?page=$i'>$i</a></li>";
			}
			//for the selected page
			if($i == $page){
				echo "<li><a class='active_link' href='popular_movies.php?page=$i'>$i</a></li>";
			}else {
				echo "<li><a href='popular_movies.php?page=$i'>$i</a></li>";
			}
