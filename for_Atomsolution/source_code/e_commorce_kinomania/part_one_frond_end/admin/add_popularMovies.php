...
?>
                ...
                <div class="row">
                    <div class="col-lg-12">
                    	<h1 class="page-header">
                            Wellcome to Admin 
                              <small>Create Popular Movies</small>
                        </h1>
                   <!-- Table Posts
 ...
 ?>                  
                       <form action="add_popularMovies.php" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <input class="btn btn-primary" type="submit" name="create_popularMovies" value="Publish New Movie"></input>
                                </div> 
                            </form>    
                    </div>
                </div>
