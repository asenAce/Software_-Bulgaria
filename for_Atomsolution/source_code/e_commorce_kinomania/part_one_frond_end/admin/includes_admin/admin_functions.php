<?php
		...
		$theQuery ="INSERT INTO popular_movies(movie_title,movie_description,movie_trailer,movie_post_img,movie_dvd_img,movie_rating,movie_director,movie_price,movie_year) ";
		$theQuery .="VALUES('$movie_title','$movie_description','$movie_trailer_href','$movie_image_poster','$movie_image_dvd','$movie_raiting','$movie_director','$movie_price','$movie_year')";	
					 $createNewMovie=$theConnection->executeTheQuery($theQuery);
							confirmTheQuery($createNewMovie);
		...
		$theQuery ="INSERT INTO tv_series(movie_title,movie_description,movie_trailer,movie_post_img,movie_dvd_img,movie_rating,movie_director,movie_price,movie_year) ";
		$theQuery .="VALUES('$movie_title','$movie_description','$movie_trailer_href','$movie_image_poster','$movie_image_dvd','$movie_raiting','$movie_director','$movie_price','$movie_year')";	
					 $createNewMovie=$theConnection->executeTheQuery($theQuery);
							confirmTheQuery($createNewMovie);
