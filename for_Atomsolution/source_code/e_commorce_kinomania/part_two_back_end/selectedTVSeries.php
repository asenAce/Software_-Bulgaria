   ...
   <!--Here the major content-->
    ...
    <?php
				if(isset($_GET['p_id'])){
					$tv_series_id = $_GET['p_id'];
					
					$sellectThePopularMovie = $theConnection->executeTheQuery("SELECT * FROM tv_series WHERE id='$tv_series_id'");
  ...
  <iframe width="560" height="315" src="<?php echo $movie_trailer; ?>" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; 	picture-in-picture" allowfullscreen></iframe>
                                ...
                                <div class=" col-lg-3 text-center col-md-2">
                                	<a href="#">
                                    	<img class="img-responsive" src="img/tv_series/<?php echo $movie_post_img; ?>" style="margin-bottom:5%;">
                                    </a>
                                 <!-- Added Modal -->
   ...
   ?>                          
              ...
              <form role="form" action="sendTheComment.php" method="post">
                    ...
                    <?php
							if($_SESSION['user']){
								echo"<button class='btn btn-lg btn-warning pull-right' style='margin-bottom:3%;' name='submitTheCommentTV_series'>Submit Comment:</button>";
							}
					?>         
