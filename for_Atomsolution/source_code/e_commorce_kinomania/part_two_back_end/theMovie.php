  ...
  <iframe width="560" height="315" src="<?php echo $movie_trailer; ?>" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; 	picture-in-picture" allowfullscreen></iframe>
                                ...
                                <div class=" col-lg-3 text-center col-md-2">
                                	<a href="#">
                                    	<img class="img-responsive" src="img/movie_posters/<?php echo $movie_post_img; ?>" style="margin-bottom:5%;">
                                    </a>
                                 <!-- Added Modal -->
   ...
   ?>                          
              ...
              <form role="form" action="insertComments.php" method="post">
                    ...
                    <?php
							if($_SESSION['user']){
								echo"<a href='insertComments.php?theKeyWord=New Movies'><button class='btn btn-lg btn-warning pull-right' style='margin-bottom:3%;' name='submitTheComment'>Submit Comment:</button></a>";
							}
					?>         
