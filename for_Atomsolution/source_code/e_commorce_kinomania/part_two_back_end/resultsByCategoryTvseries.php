...
if(isset($_GET['movieArt'])){
	...
	$movieArt = $_GET['movieArt'];
		...
		$newMoviesQueryCount = "SELECT * FROM tv_series WHERE movie_category LIKE '$movieArt'";
		...
		$sellectAllNewMovies = $theConnection->executeTheQuery("SELECT * FROM tv_series WHERE movie_category LIKE '$movieArt' LIMIT $page_1,3");
     ...
     <ul class="pager">
     	...
     	<?php
			for($i=1;$i <= $count;$i++){
				...
				echo "<li><a href='resultsByCategoryTvseries.php?page=$i&movieArt=$movieArt&theKeyWord=Tv Series'>$i</a></li>";
			}
			
			//for the selected page
			if($i == $page){
				echo "<li><a class='active_link' href='resultsByCategoryTvseries.php?page=$i&movieArt=$movieArt&theKeyWord=Tv Series'>$i</a></li>";	
			} else {
				echo "<li><a href='resultsByCategoryTvseries.php?page=$i&movieArt=$movieArt&theKeyWord=Tv Series'>$i</a></li>";
			}
