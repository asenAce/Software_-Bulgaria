...
?>
 ...
 ?>                  
                       <form action="add_tvSeries.php" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <input class="btn btn-primary" type="submit" name="create_tvSeries" value="Publish New Movie"></input>
                                </div> 
                            </form>    
                    </div>
                </div>
