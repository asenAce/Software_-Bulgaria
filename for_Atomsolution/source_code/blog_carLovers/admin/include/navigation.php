	...
	<div class="navbar-header">
      ...
      <div class="collapse navbar-collapse navbar-ex1-collapse">
      	<ul class="nav navbar-nav side-nav">
            ...
            <li>
            	<a href="javascript:;" data-toggle="collapse" data-target="#services"><i class="fa fa-fw fa-arrows-v"></i>Create service<i class="fa fa-fw fa-caret-down"></i></a>
                	<ul id="services" class="collapse">
                    	<li>
                        	<a href="addService.php">Create Servise</a>
                        </li>
                        <li>
